package br.muffato.produtos.data.integracaosap.components;
 ...
 * <p>
 * Items can be added using {@link (AppNavItem)} and hierarchy can be
...
public class AppNav extends Component implements HasSize, HasStyle {
     ...
     */
    public AppNav addItem(br.muffato.produtos.data.integracaosap.components.AppNavItem... appNavItems) {
